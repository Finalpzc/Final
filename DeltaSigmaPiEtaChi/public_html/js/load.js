$( function() { //shorthand for document when ready
    ...
    function checkingCookie(x) {
        ...
        if (user !== "") {
            ...
            var t = document.getElementById("favoriteDiv");
            t.appendChild(icon);
            console.log("star");
        } else {
          console.log("no star");
    ...
    var x = breakUpURLParameters(url);
      ...
      var switcher;
      if (x.search.cpt === "Street") {
        switcher = 0;
        console.log(switcher);
        checkingCookie(switcher);
      } else if (x.search.cpt === "Spirit") {
        switcher = 1;
        console.log(switcher);
        checkingCookie(switcher);
      } else if (x.search.cpt === "Watermelon") {
        switcher = 2;
        console.log(switcher);
        checkingCookie(switcher);
      } else if (x.search.cpt === "Obey") {
        switcher = 3;
        console.log(switcher);
        checkingCookie(switcher);
      } else if (x.search.cpt === "ObeyYellow") {
        switcher = 4;
        console.log(switcher);
        checkingCookie(switcher);
      } else if (x.search.cpt === "WellConnected") {
        switcher = 5;
        console.log(switcher);
        checkingCookie(switcher);
      }
